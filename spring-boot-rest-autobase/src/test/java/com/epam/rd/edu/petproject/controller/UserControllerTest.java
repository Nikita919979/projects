...
public class UserControllerTest {
  ...
  public void shouldReturnListOfUserDtoDetails() throws Exception {
    ...
    mockMvc.perform(get("/users")
        ...
        .andExpect(jsonPath("$[0].uuid", is(inputUserDtoList.get(0).getUuid().toString())))
        ...
        .andExpect(jsonPath("$[1].uuid", is(inputUserDtoList.get(1).getUuid().toString())))
  ...
  public void shouldReturnUserDtoDetails() throws Exception {
    ...
    mockMvc.perform(get("/users/df9e5624-71db-11ea-bc55-0242ac130003")
        .accept(APPLICATION_JSON_UTF8))
        .andExpect(status().isOk())
        .andExpect(jsonPath("$.uuid", is(inputUserDto.getUuid().toString())))
