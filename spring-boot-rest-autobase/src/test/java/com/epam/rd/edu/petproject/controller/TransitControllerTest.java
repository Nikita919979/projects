...
public class TransitControllerTest {
  ...
  public void shouldReturnListOfTransitDtoDetails() throws Exception {
    ...
    mockMvc.perform(get("/transits")
        ...
        .andExpect(jsonPath("$[0].uuid", is(inputTransitDtoList.get(0).getUuid().toString())))
        .andExpect(
            jsonPath("$[0].city_from.uuid",
                is(inputTransitDtoList.get(0).getCity_from().getUuid().toString())))
        .andExpect(
            jsonPath("$[0].city_from.name",
                is(inputTransitDtoList.get(0).getCity_from().getName())))
        .andExpect(
            jsonPath("$[0].city_to.uuid",
                is(inputTransitDtoList.get(0).getCity_to().getUuid().toString())))
        .andExpect(
        ...
        .andExpect(jsonPath("$[0].user.uuid",
            is(inputTransitDtoList.get(0).getUser().getUuid().toString())))
        ...
        .andExpect(
            jsonPath("$[0].driver.uuid",
                is(inputTransitDtoList.get(0).getDriver().getUuid().toString())))
        .andExpect(
        ...
        .andExpect(
            jsonPath("$[0].car.uuid", is(inputTransitDtoList.get(0).getCar().getUuid().toString())))
        .andExpect(
        ...
        .andExpect(jsonPath("$[1].uuid", is(inputTransitDtoList.get(1).getUuid().toString())))
        .andExpect(
            jsonPath("$[1].city_from.uuid",
                is(inputTransitDtoList.get(1).getCity_from().getUuid().toString())))
        .andExpect(
            jsonPath("$[1].city_from.name",
                is(inputTransitDtoList.get(1).getCity_from().getName())))
        .andExpect(
            jsonPath("$[1].city_to.uuid",
                is(inputTransitDtoList.get(1).getCity_to().getUuid().toString())))
        .andExpect(
        ...
        .andExpect(jsonPath("$[1].user.uuid",
            is(inputTransitDtoList.get(1).getUser().getUuid().toString())))
        ...
        .andExpect(
            jsonPath("$[1].driver.uuid",
                is(inputTransitDtoList.get(1).getDriver().getUuid().toString())))
        .andExpect(
        ...
        .andExpect(
            jsonPath("$[1].car.uuid", is(inputTransitDtoList.get(1).getCar().getUuid().toString())))
        .andExpect(
  ...
  public void shouldReturnTransitDtoDetails() throws Exception {
    ...
    mockMvc.perform(get("/transits/f1344876-71db-11ea-bc55-0242ac130003")
        .accept(APPLICATION_JSON_UTF8))
        .andExpect(status().isOk())
        .andExpect(jsonPath("$.uuid", is(inputTransitDto.getUuid().toString())))
        .andExpect(
            jsonPath("$.city_from.uuid", is(inputTransitDto.getCity_from().getUuid().toString())))
        .andExpect(
            jsonPath("$.city_from.name",
                is(inputTransitDto.getCity_from().getName())))
        .andExpect(
            jsonPath("$.city_to.uuid", is(inputTransitDto.getCity_to().getUuid().toString())))
        .andExpect(
            jsonPath("$.city_to.name", is(inputTransitDto.getCity_to().getName())))
        .andExpect(jsonPath("$.status", is(inputTransitDto.getStatus().name())))
        .andExpect(jsonPath("$.user.uuid", is(inputTransitDto.getUser().getUuid().toString())))
        ...
        .andExpect(jsonPath("$.driver.uuid", is(inputTransitDto.getDriver().getUuid().toString())))
        .andExpect(
        ...
        .andExpect(jsonPath("$.car.uuid", is(inputTransitDto.getCar().getUuid().toString())))
        .andExpect(
